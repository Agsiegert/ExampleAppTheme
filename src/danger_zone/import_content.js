...
function importContent() {
  allExistingImages().then(images => {
    ...
    const unsplashBusyStreetDusk = uploadImage(unsplashBusyStreetDuskData, 'Busystreetdusk', UNSPLASH_TAGS);
    const unsplashBwCoffeeKeyboardMouse = uploadImage(unsplashBwCoffeeKeyboardMouseData, 'Bwcoffeekeyboardmouse', UNSPLASH_TAGS);
    const unsplashBwSuitPolkadotsLaptop = uploadImage(unsplashBwSuitPolkadotsLaptopData, 'Bwsuitpolkadotslaptop', UNSPLASH_TAGS);
    const unsplashCactusMacPurple = uploadImage(unsplashCactusMacPurpleData, 'Cactusmacpurple', UNSPLASH_TAGS);
    const unsplashClosingLaptop = uploadImage(unsplashClosingLaptopData, 'Closing laptop', UNSPLASH_TAGS);
    const unsplashComputerBeCreative = uploadImage(unsplashComputerBeCreativeData, 'Computerbecreative', UNSPLASH_TAGS);
    ...
    const unsplashDeveloperSunrise = uploadImage(unsplashDeveloperSunriseData, 'Developersunrise', UNSPLASH_TAGS);
    const unsplashDimLaptopStand = uploadImage(unsplashDimLaptopStandData, 'Dim laptop stand', UNSPLASH_TAGS);
    const unsplashDistractingWindowsTable = uploadImage(unsplashDistractingWindowsTableData, 'Distractingwindowstable', UNSPLASH_TAGS);
    ...
    const unsplashEmptyCafeWindows = uploadImage(unsplashEmptyCafeWindowsData, 'Emptycafewindows', UNSPLASH_TAGS);
